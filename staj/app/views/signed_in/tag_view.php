        ...
        <div class="row mx-auto vh-100">
            ...
            <div class="col-md-7 p-4">
                <div class="row">
                    ...
                    <div class="col d-flex justify-content-end">
                        <?php if ($follow == null) : ?>
                            <form action="../post/follow_tag" method="POST" name="follow_tag_form">
                                <input value="<?= $tag['id'] ?>" name="f_t_id" hidden>
                                <button type="submit" class="btn btn-primary" name="follow_tag">Takip Et</button>
                            </form>
                        <?php else : ?>
                            <form action="../post/unfollow_tag" method="POST" name="unfollow_tag_form">
                                <input value="<?= $tag['id'] ?>" name="f_t_id" hidden>
                                <button type="submit" class="btn btn-outline-primary" name="unfollow_tag">Takibi Bırak</button>
                            </form>
                        <?php endif; ?>
                    </div>
                </div>
