    ...
    <div class="container">
        <div class="row mx-auto vh-100">
            ...
            <div class="col-md-7 p-4">
                <div class="row my-2">
                    <div class="col">
                        <p class="lead fs-4 text-decoration-none text-dark"><strong>Yanıtı Düzenle</strong></p>
                        <form action="../../../post/edit_answer" method="POST" name="answer_question_form">
                            <input name="a_e_id" id="a_e_id" value=<?= $edit_answer['id'] ?> hidden>
