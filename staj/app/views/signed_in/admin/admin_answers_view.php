            ...
            <div class="col-md-7 p-4">
                <table class="table" style="table-layout: fixed;">
                    <thead>
                        <tr>
                            ...
                            <th class="col-md-2" scope="col">Kullanıcı ID</th>
                            <th class="col-md-2" scope="col">Soru ID</th>
                            <th class="col-md-3" scope="col">İçerik</th>
                            <th class="col-md-1" scope="col">Tarih</th>
                            <th class="col-md-1" scope="col">Düzenle</th>
                            <th class="col-md-1" scope="col">Sil</th>
                        </tr>
                    </thead>
                    <?php foreach ($answers_limit as $answer_limit) : $answer_limit['content'] = preg_replace("/<img[^>]+\>/i", " ", $answer_limit['content']);
                        $answer_limit['content'] = preg_replace("/<br>/i", " ", $answer_limit['content']); ?>
                        <tbody>
                            <tr>
                                <th scope="row"><?= $answer_limit['id'] ?></th>
                                <td><?= $answer_limit['user_id'] ?></td>
                                <td><?= $answer_limit['question_id'] ?></td>
                                <td class="text-truncate"><?= $answer_limit['content'] ?></td>
                                <td><?= $answer_limit['create_date'] ?></td>
                                <td>
                                    <a class="text-decoration-none" href="answers/<?= $answer_limit['id'] ?>">
                                        <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
                                ...
                                <td>
                                    <a class="text-decoration-none" href="answers/<?= $answer_limit['id'] ?>/delete">
                                        <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
                ...
                <nav aria-label="...">
                    <ul class="pagination pagination-md justify-content-center pt-4">
                        <?php for ($page = 1; $page <= $answers_page; $page++) : ?>
