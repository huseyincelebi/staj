            ...
            <div class="col-md-7 p-4">
                <div class="row my-2">
                    <div class="col">
                        ...
                        <form action="../../admin/answers/edit" method="POST" name="answer_question_form">
                            <input name="a_e_id" id="a_e_id" value=<?= $answers_edit['id'] ?> hidden>
                            <input name="a_e_data" id="a_e_data" hidden>
                            ...
                            <div class="input-group p-2" id="t_editor_q_e" contentEditable="true" style="display: inline-block;border:1px solid #ced4da;min-height:240px;resize: vertical;overflow: auto;">
                                <?= $answers_edit['content'] ?>
                            </div>
                            <div class="d-flex justify-content-end">
                                <button type="submit" class="btn btn-primary my-2 w-25" name="edit_answer">Düzenle</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
        ...
        function add_image_answer() {
            ...
            $.ajax(settings).done(function(response) {
                ...
                $('#a_e_data').val($('#t_editor_q_e').html().trim());
            });
        }
    </script>
    <script>
