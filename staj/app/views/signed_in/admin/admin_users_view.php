        ...
        <div class="row mx-auto vh-100">
            ...
            <div class="col-md-7 p-4">
                <table class="table">
                    ...
                    <?php foreach ($users_limit as $user_limit) : ?>
                        <tbody>
                            <tr>
                                <th scope="row"><?= $user_limit['id'] ?></th>
                                <td><?= $user_limit['username'] ?></td>
                                <td><?= $user_limit['email'] ?></td>
                                <td><?= $user_limit['password'] ?></td>
                            </tr>
                        </tbody>
                    <?php endforeach; ?>
                </table>
                <nav aria-label="...">
                    <ul class="pagination pagination-md justify-content-center pt-4">
                        <?php for ($page = 1; $page <= $users_page; $page++) : ?>
