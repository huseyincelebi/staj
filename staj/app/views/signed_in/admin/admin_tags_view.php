        ...
        <div class="row mx-auto vh-100">
            ...
            <div class="col-md-7 p-4">
                <table class="table">
                    ...
                    <?php foreach ($tags_limit as $tag_limit) : ?>
                        <tbody>
                            <tr>
                                <th scope="row"><?= $tag_limit['id'] ?></th>
                                <td><?= $tag_limit['name'] ?></td>
                                <td>
                                    <a class="text-decoration-none" href="tags/<?= $tag_limit['id'] ?>">
                                        <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
                                ...
                                <td>
                                    <a class="text-decoration-none" href="tags/<?= $tag_limit['id'] ?>/delete">
                                        <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
                ...
                <nav aria-label="...">
                    <ul class="pagination pagination-md justify-content-center pt-4">
                        <?php for ($page = 1; $page <= $tags_page; $page++) : ?>
