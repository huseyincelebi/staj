    ...
    <div class="container">
        <div class="row mx-auto vh-100">
            ...
            <div class="col-md-7 p-4">
                <div class="row my-2">
                    <div class="col">
                        <p class="lead fs-4 text-decoration-none text-dark"><strong>Tagı Düzenle</strong></p>
                        <form action="../../admin/tags/edit" method="POST" name="answer_question_form">
                            <input name="t_e_id" value="<?= $tags_edit['id'] ?>" hidden>
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1">Başlık</span>
                                <input type="text" class="form-control" name="t_e_name" value="<?= $tags_edit['name'] ?>">
                            </div>
                            <div class="d-flex justify-content-end">
                                <button type="submit" class="btn btn-primary my-2 w-25" name="edit_tag">Düzenle</button>
                            </div>
                        </form>
                    </div>
                </div>
