            ...
            <div class="col-md-7 p-4">
                <div class="row my-2">
                    <div class="col">
                        ...
                        <form action="../../post/edit_question" method="POST" name="answer_question_form">
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1">Başlık</span>
                                <input type="text" class="form-control" name="q_e_title" value="<?= $edit_question['title'] ?>">
                            </div>
                            <div class="input-group mb-3">
                            ...
                            <input name="q_e_id" id="q_e_id" value=<?= $edit_question['id'] ?> hidden>
