    ...
    <div class="container">
        <div class="row mx-auto vh-100">
            ...
            <div class="col-md-7 p-4">
                <div class="row">
                    <div class="col">
                        <h1 class="lead fs-3"><strong><?= $tag['name'] ?> Tag'ı</strong></h1>
                    </div>
                </div>
                <div class="row mt-4 align-items-center">
                    <div class="col">
                        <h1 class="lead fs-6"><strong>Toplam <?= $tag_questions_count ?> soru soruldu</strong></h1>
                    </div>
                    <div class="col d-flex justify-content-end">
                        <div class="btn-group" role="group" aria-label="Basic outlined example">
                            <?php if (isset($_GET['page'])) : ?>
                                ...
                                <a href="<?= parse_url($_SERVER["REQUEST_URI"], PHP_URL_PATH) . '?page=' . $_GET['page']; ?>&filter=popular" type="button" class="btn btn-outline-primary">En&nbsp;Popüler</a>
                                <a href="<?= parse_url($_SERVER["REQUEST_URI"], PHP_URL_PATH) . '?page=' . $_GET['page']; ?>&filter=unanswered" type="button" class="btn btn-outline-primary">Yanıtlanmamış</a>
                            <?php else : ?>
                        ...
                        <div class="d-flex mt-4 justify-content-between">
                            <div>
                                ...
                                <?php foreach ($questions_tags as $questions_tag) : if ($questions_tag['question_id'] == $question['id']) : ?>
                                        <span class="badge bg-secondary"><?= $tags[array_search($questions_tag['tag_id'], array_column($tags, 'id'))]['name']; ?></span>
                                <?php endif;
                                endforeach; ?>
                            </div>
